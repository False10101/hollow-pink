...
function MpLogo() {
  return (
    ...
    >
      <defs>
        <linearGradient id="mLogoLeftApp" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#22d3ee" />
          <stop offset="100%" stopColor="#3b82f6" />
        </linearGradient>
        <linearGradient id="mLogoRightApp" x1="100%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="#e879f9" />
          <stop offset="100%" stopColor="#8b5cf6" />
        </linearGradient>
        <filter id="mLogoGlowApp" x="-20%" y="-20%" width="140%" height="140%">
      ...
      <g filter="url(#mLogoGlowApp)">
        <path
          d="M 6 33 L 14 11 L 24 25"
          fill="none"
          stroke="url(#mLogoLeftApp)"
          strokeWidth="5.5"
          strokeLinecap="round"
